...
/*   Updated: 2025/09/11 14:02:32 by macauchy         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	Request::setTrailer( const std::string& key, const std::string& value )
{
	_trailers[normalizeKey(key)] = value;
}

std::map<std::string, std::string> const &Request::getTrailers( void ) const
{
	return (_trailers);
}
