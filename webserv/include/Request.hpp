...
/*   Updated: 2025/09/11 14:02:06 by macauchy         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
class Request
{
	public:
		...
		const std::map<std::string, std::string> &getTrailers( void ) const;
	...
	private:
		...
		std::map<std::string, std::string>	_trailers;	// Trailers (for chunked transfer encoding)
